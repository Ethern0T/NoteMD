...
extern guint (*g_idle_add) (void *, Ptr);
extern gboolean (*g_source_remove) (guint);
extern void (*gtk_label_set_ellipsize) (Ptr, int);
extern void (*gtk_label_set_max_width_chars) (Ptr, int);
extern void (*gtk_editable_set_width_chars) (Ptr, int);
